...
Register Here : [Rats Kingdom](http://t.me/RatsKingdom_Bot/join?startapp=6164400919)

Join Our Channel:- [ A](https://t.me/+bnl8_wZ6Dfg0YmE0)
...
1. **Kloning repositori:**
   ```bash
   git clone https://github.com/CRYPTOMASTER09/Rats.git
   ```
   ```bash
   cd Rats
   ```
